...
Route::prefix('v1')->middleware('auth:sanctum')->group(function () {
    ...
    Route::post('/auth/users/{userId}/deactivate', [AuthController::class, 'deactivateUser']);
    Route::post('/auth/users/{userId}/activate', [AuthController::class, 'activateUser']);
    Route::post('/auth/users/{userId}/revoke-tokens', [AuthController::class, 'revokeAllTokens']);
    ...
    // Facturas (protegido por company.access)
    Route::middleware('company.access')->prefix('invoices')->group(function () {
    ...
    // Boletas (protegido por company.access)
    Route::middleware('company.access')->prefix('boletas')->group(function () {
    ...
    // Resúmenes Diarios (protegido por company.access)
    Route::middleware('company.access')->prefix('daily-summaries')->group(function () {
    ...
    // Notas de Crédito (protegido por company.access)
    Route::middleware('company.access')->prefix('credit-notes')->group(function () {
    ...
    // Notas de Débito (protegido por company.access)
    Route::middleware('company.access')->prefix('debit-notes')->group(function () {
